...
<html>
<head>
<title>Property Ind Dot Com - Post Requirement, Add Property Requirement</title>

<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="propertyindia, india property, property india, post requirement, residential property, commercial properties, propertyind">
...
<div class="men">
	<div class="container">
		...
		?>
		  	  ...
		  	  <form id="postRequirement" name="postRequirement" action="listRequirement.php" method="post" onsubmit="return validateForm(this);"> 
				 ...
				 <div class="register-bottom-grid">
					<h3>LOCATION</h3>
							...
							<div>
								...
								<input type="text" id="builders" name="builders" maxlength="25" >
							 </div>
							 <div>
				...
				<div class="register-bottom-grid">
							<div>
								<span>Age of Construction<label>*</label></span>
								<input type="text" id="totalPrice" name="age" maxlength="14" >
							 </div>
							 <div>
				...
				<div class="register-but">
				   ...
				   <input type="submit"  value="Requirement" name="Requirement"  background-color="#e05b5b">
					   <div class="clearfix"> </div>
