...
<title>Chennai Properties, Real Estates Chennai, Residential Chennai, Property India, Propertyind</title>
...
<meta name="keywords" content="search property, search properties, propertyind, propertyindia, real estate, property search, residential plot, residential house, multistorey apartment, builder floor apartment, villa, property in india, india properties, property website, india homes">
  ...
  <div class="global_navbg blue_link3 width pad_tp1 pad_btm3">
		<div class="globalnav_bx3 flt_lft pad_lft1">
            <a href="http://www.propertyind.com/myLoanTool.html" rel="dropmenu6">Loans</a>
             &nbsp;|&nbsp;
            <a href="http://www.propertyind.com/India-property.html" target="_blank" rel="dropmenu8">NRI Section</a>
             &nbsp;|&nbsp;
            <a href="http://www.propertyind.com/propertyNews.html" target="_blank">Property News</a>
			 &nbsp;|&nbsp;
		...
		<a href="http://www.propertyind.com/welcome.php">Home</a> &nbsp;|&nbsp;
...
<div class="site_width pad_tp3">
    <div class="pad_rht1">
        <div class="pad_lft1 flt_lft"><a href="http://www.propertyind.com/welcome.php"><img src="css/logo.gif" alt="propertyind.com" border="0" height="105" width="275"></a>
         </div>
		 <div class="pad_lft1 flt_lft"><a href="http://www.propertyind.com/welcome.php"><img src="css/banner2.gif" alt="propertyind.com" border="0" height="105" width="495"></a>
        </div>
		<div class="pad_lft1 flt_lft"><a href="http://www.propertyind.com/welcome.php"><img src="css/banner1.gif" alt="propertyind.com" border="0" height="105" width="190"></a>
         </div>
    </div>
 </div>
...
<div id="page-wrap" style="z-index: 0;">
       ...
       <ul class="dropdown">
            ...
            <ul class="sub_menu city">
        			 ...
        			 <li><a href="http://www.propertyind.com/India-property.html" target="_blank" rel="dropmenu8">For NRIs</a></li>
        			 <li><a href="http://www.propertyind.com/propertyNews.html" target="_blank">Property News</a></li>
        		</ul>
        	</li>
        </ul>
   	...
   	<!--City Special Links starts here-->
    	...
    	<div class="cityBlk">
        	<ul class="cityUL">
				...
				<li><a href="http://www.propertyind.com/Residential_Madurai.html">Madurai</a></li>


                <li onmouseover="document.getElementById('ct_more').style.display='block'; document.getElementById('baseFrm').style.display='block'" onmouseout="document.getElementById('ct_more').style.display='none'; document.getElementById('baseFrm').style.display='none'">
                <a href="#">More...</a>
...
<div class="lft_panel flt_lft"><!-- code for left panel -->
	
	<div class="main_srchbox mar_b10">
		<h3>Buy/ Sell a Property</h3>
		<ul>
		<li class="brdr_dash">
			<a href="http://www.propertyind.com/postProperty.php">Post your Property</a>
		</li>
		<li>
			<a href="http://www.propertyind.com/postRequirement.php">Post your Requirement</a>
		</li>
		</ul>
	</div>
	...
	<div class="main_srchbox mar_b10">
		...
		<ul>
			<li class="brdr_dash">
			<a href="http://www.propertyind.com/nri/India-property.html">NRI Section</a>
			</li>
			<li>
	...
	<div><a href="http://www.propertyind.com/advertise.php" target="_blank"><img src="css/inaugural_offer.gif" border="0" height="215" width="175"></a>
	</div>

	<img src="css/ti.gif" border="0" height="1" width="1">

</div><!-- close for left panel -->
<!-- Getting Search Information  -->
<?php
if ((isset($_REQUEST["submit"])) or (isset($_REQUEST["currentpage"]))){
		...
		echo "Number of rows in tables " . $numrows . " Total pages " . $totalpages . " Current page " . $currentpage;
		...
		$offset = ($currentpage - 1) * $rowsperpage;
	   	...
	   	$sql="select * from property order by city  LIMIT $offset, $rowsperpage";
	   	//$sql="select * from property order by city having city = '" . $city . "' LIMIT $offset, $rowsperpage";
		$result = mysql_query($sql, $conn) or trigger_error("SQL", E_USER_ERROR);
...
<div class="mdl_panel flt_lft expanded_rmp">
	...
	<div class="midsrch_box ">
	     <h1>Search properties : <?php echo $city ?></h1>
	</div>
	<div class="mand_txt pad_tp2">Search Results </div>
