...
<title>Property India, Search Real Estate Property Buyers, Property Buyers India, Post Property Requirements	</title>
<meta name="description" content="Search for buyers, propertyindia, residential house, plot, multistorey apartment, builder floor apartment, villa, propertyind.com">
<meta name="keywords" content="propertyindia, property buyers, post property requirements, search property, search properties, search for property,  residential plot, residential house, multistorey apartment, builder floor apartment, villa, propertyind.com">
...
<link href="css/search_css.css" rel="stylesheet" type="text/css">
	<div class="lft_panel flt_lft">
		...
		<div class="main_srchbox mar_b10">
			...
			<ul>
				<li class="brdr_dash">
					<a href="nri/India-property.html">NRI Section</a>
				</li>
				<li>
...
<!-- code for middle panel -->
	        ...
	        <div class="midsrch_box ">
	            <h1>Search for Requirements</h1>
	        </div>
	       	<div class="mand_txt pad_tp2">Search Results for Requirements</div>
<?php
if (isset($_REQUEST["submit"])){
	...
	$name="agent";
	$sql="select * from requirement order by requirement_id";
...
<table width="800" border="0" cellpadding="3" cellspacing="1" bgcolor="#DDDDDD">
	<tr width="800" border="0" cellpadding="3" cellspacing="1" bgcolor="#DDDDDD">
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>Req. Id</strong></td>
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>Property type</strong></td>
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>Covered Area</strong></td>
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>Plot Area</strong></td>
		<td width="25%" align="center" bgcolor="#DDDDDD"><strong>Locality</strong></td>
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>City</strong></td>
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>State</strong></td>
		<td width="10%" align="center" bgcolor="#DDDDDD"><strong>Country</strong></td>
		<td width="15%" align="center" bgcolor="#DDDDDD"><strong>Budget</strong></td>
	...
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['requirement_id']; ?></td>
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['property_type']; ?></td>
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['coveredArea1']; ?></td>
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['landArea1']; ?></td>
	<td width="25%" align="center" bgcolor="#77AAEE"><?php echo $rows['locality']; ?></td>
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['city']; ?></td>
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['state']; ?></td>
	<td width="10%" align="center" bgcolor="#77AAEE"><?php echo $rows['country'];?> </td>
	<td width="15%" align="center" bgcolor="#77AAEE"><?php echo $rows['budgetMinimum']; ?></td>
...
{
?>
 	<form id="searchFormBean" name="requirement" action="requirementSearch.php" method="post" onsubmit="return validateForm(this)">
    <input id="source" name="source" value="requirementSearch" type="hidden">
         ...
         <p class="frm_cntrls">
	     <label>Type Of Property<em>*</em> :</label>
	     <span class="frm_cnt">
			...
			<div id="propTypeErrDivMsg" class="err_msg"></div>
				&nbsp;[ <span class="helptxt">You may select upto 5 options.</span> ]<br>&nbsp;[ <span class="helptxt">To select more than one option, keep Ctrl key pressed. </span> ]
                   </span>
             <span class="cl"></span>
             </p>
            </div>
...
<script language="JavaScript1.1" src="css/ads"></script><br><br></div>
            <!-- End of Afc bottom -->
	</div>
