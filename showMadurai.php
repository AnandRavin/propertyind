...
<title>Real Estate Madurai, Residential Property Madurai</title>
<meta name="description" content="Search properties Madurai, residential plot Madurai, house Madurai, multistorey apartment Madurai, flats Madurai, builder apartment, villa Madurai, propertyindia, propertyind.com">
<meta name="keywords" content="search property Madurai, propertyind, propertyindia, real estate Madurai, villas Madurai, farm house Madurai">
...
if ((isset($_REQUEST["submit"])) or (isset($_REQUEST["currentpage"]))){
		...
		$sql = "select count(*) from property where city='Madurai' order by city ";
		...
		$sql="select * from property where city='Madurai' order by city LIMIT $offset, $rowsperpage";
		$result = mysql_query($sql, $conn) or trigger_error("SQL", E_USER_ERROR);
...
<div class="mdl_panel flt_lft expanded_rmp">
	...
	<div class="midsrch_box ">
	     <h1>Search properties : Madurai</h1>
	</div>
...
<table width="800" border="0" cellpadding="3" cellspacing="1" bgcolor="#DADADA">
	...
	<form id='<?php echo $form_id ?>' action="/madurai_property.php" method="GET">
    ...
    <td align="center"><?php echo $rows['address']; ?><br/>
