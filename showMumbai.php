...
<title>Real Estate Mumbai, Residential Property Mumbai</title>
<meta name="description" content="properties Mumbai, residential Mumbai, house Mumbai, apartment Mumbai, flats Mumbai, builder apartment, villa Mumbai, propertyindia, propertyind.com">
<meta name="keywords" content="search property Mumbai, propertyind, propertyindia, real estate Mumbai, villas Mumbai, farm house Mumbai">
...
<div class="lft_panel flt_lft"><!-- code for left panel -->
	...
	<div class="main_srchbox mar_b10">
		...
		<ul>
			...
			<li>
			<a href="http://www.propertyind.com/propertyNews.php">Latest Property News</a>
			</li>
		</ul>
    </div>
...
if ((isset($_REQUEST["submit"])) or (isset($_REQUEST["currentpage"]))){
		...
		$sql = "select count(*) from property where city='Mumbai' order by property_id desc ";
		...
		$sql="select * from property where city='Mumbai' order by property_id desc LIMIT $offset, $rowsperpage";
		$result = mysql_query($sql, $conn) or trigger_error("SQL", E_USER_ERROR);
...
<table width="800" border="0" cellpadding="3" cellspacing="1" bgcolor="#DADADA">
	...
	<form id='<?php echo $form_id ?>' action="/mumbai_property.php" method="GET">
    ...
    <td align="center"><?php echo $rows['address']; ?>, <br> Email:propertyind2014@gmail.com, 9600035400<br/>
